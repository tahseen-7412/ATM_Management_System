...
public class ATM extends JFrame {
	...
	protected void buildApp(){
		...
		displayArea.setPreferredSize(new Dimension(200, 150));
		JPanel bottomArea = new JPanel();
		bottomArea.setLayout(new BorderLayout(50,25));
		JPanel buttonPanel = new JPanel();
		buttonPanel.setLayout(new BorderLayout(50,25));
